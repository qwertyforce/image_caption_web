...
if not os.path.isfile("checkpoints/caption.pt"):
    if not os.path.exists("checkpoints"):
        os.makedirs("checkpoints")
    wget.download("https://ofa-silicon.oss-us-west-1.aliyuncs.com/checkpoints/caption_large_best_clean.pt","./checkpoints/caption.pt")
# exit()
